          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              <div className="flex items-center mb-4">
                <div className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center" style={{ marginRight: '10px' }}>
                  <span className="text-lg font-bold text-white">B</span>
                </div>
                <h3 className="text-xl font-bold text-white">Portfolio</h3>
              </div>
              <p className="text-gray-400 mb-6 text-sm leading-relaxed" style={{ marginTop: '10px' }}>
              ...
              <div className="flex space-x-3" style={{ marginTop: '10px' }}>
                <a href="https://x.com/bcadev" target="_blank" rel="noopener noreferrer" 
                ...
                <a href="https://www.linkedin.com/in/berkaycanakkoc/" target="_blank" rel="noopener noreferrer"
                   className="w-9 h-9 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-blue-600 transition-colors">
                  <svg className="w-5 h-5 text-gray-300" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                  </svg>
                </a>
                <a href="https://github.com/berkayakkocc" target="_blank" rel="noopener noreferrer" 
                   className="w-9 h-9 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-blue-600 transition-colors">
                  <svg className="w-5 h-5 text-gray-300" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center text-gray-400">
                  ...
                  <span className="text-sm">{about?.email || 'Yükleniyor...'}</span>
                </div>
                <div className="flex items-center text-gray-400">
                  <svg className="w-4 h-4 text-blue-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <span className="text-sm">{about?.phone || 'Yükleniyor...'}</span>
                </div>
                <div className="flex items-center text-gray-400">
                  <svg className="w-4 h-4 text-blue-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-sm">{about?.location || 'Yükleniyor...'}</span>
                </div>
              </div>
            </div>
          </div>
